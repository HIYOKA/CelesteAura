						...
						'elements' => apply_filters( 'pafw_admin_gateway_settings',
							array(
								...
								array(
									...
									"type"      => "Toggle",
									"default"   => "no",
									"desc"      => __( '<div class="desc2">토스페이먼츠 (구. LG유플러스) 결제 시스템을 이용합니다. (정기결제, 예약결제 지원)</div>', 'pgall-for-woocommerce' ),
									"action"    => array(
										"icon"   => "cogs",
										"show"   => "yes",
										"target" => "_blank",
					...
					array(
						...
						'elements' => array(
							...
							array(
								...
								"className" => "",
								'showIf'    => array( 'pafw-gw-inicis' => 'yes', 'pafw-gw-kcp' => 'yes', 'pafw-gw-nicepay' => 'yes', 'pafw-gw-lguplus' => 'yes' ),
								"type"      => "Toggle",
								"default"   => "no",
							...
							array(
								...
								"className" => "",
								'showIf'    => array( array( 'pafw-gw-inicis' => 'yes', 'pafw-gw-kcp' => 'yes', 'pafw-gw-nicepay' => 'yes', 'pafw-gw-lguplus' => 'yes'  ), array( 'pafw_bacs_always_issue_receipt' => 'yes' ) ),
								"type"      => "LabeledInput",
