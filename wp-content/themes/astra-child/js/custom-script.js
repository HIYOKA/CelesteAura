//결제 페이지에서 로그인 폼 부분이 번역이 안되서 쓰는 함수
document.addEventListener('DOMContentLoaded', function() {
 ...
    usernameLabel.textContent = '유저명 또는 이메일';
  ...
  if (loginButton) {
	...
	// 'Remember me' 부분 삭제
  var rememberMeLabel = document.querySelector('.woocommerce-form__label-for-checkbox');
  if (rememberMeLabel) {
    rememberMeLabel.remove();
  }
  
  // 'Remember me' 체크박스 삭제
  var rememberMeCheckbox = document.querySelector('.woocommerce-form__input-checkbox');
