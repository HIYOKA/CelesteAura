...
const Recommend = () => {
  ...
  async function getCategoryID(categoryName) {
    ...
    try {
      ...
      const category = categories.find((cat) => cat.name === categoryName); // find : 배열에서 특정 조건을 만족하는 첫 번째 요소를 반환
      return category?.id;
    } catch (error) {
    ...
    <div id="randomrecommendpage">
      ...
      <div className="container">
        <select
          ...
          onChange={handleRecommendMethodChange}
          value={recommendMethod}
        >
